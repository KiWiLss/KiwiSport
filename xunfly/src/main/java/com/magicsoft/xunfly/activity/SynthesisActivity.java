package com.magicsoft.xunfly.activity;
...
import com.magicsoft.xunfly.R;
import com.magicsoft.xunfly.TtsSettings;
...
public class SynthesisActivity extends AppCompatActivity {
    ...
    public void synthesis(View view) {
        ...
        // 设置参数
        setParam();
        String text="这个那个那个这个这个那个那个这个这个那个那个这个这个那个那个这个这个那个那个这个";
