...
public class PoiOverlay {
   ...
   // private RouteOverLay mRouteOverLay;
    private double mMarkLongitude, mMarkLatitude;
    public int tab;
    public Marker mMarker2;
     ...
     * @since V2.1.0
     */
    public PoiOverlay(Context context, AMap amap, List<PoiItem> pois, Resources resources) {
    ...
    public void addToMap() {
       // try {
            for (int i = 0; i < mPois.size(); i++) {
                mMarker = mAMap.addMarker(getMarkerOptions(i));
                mMarker.setObject(i);
                mPoiMarks.add(mMarker);
                mMarker2 = mPoiMarks.get(i);
    ...
    protected BitmapDescriptor getBitmapDescriptor(int index) {
        ...
        BitmapDescriptor bitmapDescriptor = BitmapDescriptorFactory.fromBitmap
                (BitmapFactory.decodeResource(mResources, R.mipmap.big_blue_landmark));
